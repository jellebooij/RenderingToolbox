...
namespace Rb {
	...
	Vec3 operator+(const Rb::Vec3 & a, const Rb::Vec3 & b)
	{
		return Rb::Vec3(a.x + b.x, a.y + b.y, a.z + b.z);
	}
	...
	Vec3 operator*(const Rb::Vec3 & a, const float & b)
	{
		return Rb::Vec3(a.x * b, a.y * b, a.z * b);
	}

	Vec3 operator*(const float & a, const Rb::Vec3 & b)
	{
		return Rb::Vec3(b.x * a, b.y * a, b.z * a);
	}
